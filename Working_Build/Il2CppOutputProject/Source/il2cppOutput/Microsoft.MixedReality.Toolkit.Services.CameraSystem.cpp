...
IL_00df:
	...
	}
	{
		...
		bool L_38;
		L_38 = MixedRealityCameraSystem_get_IsOpaque_m9455B78E765C8609347E7B0A7B377698527A9F0A(__this, /*hidden argument*/NULL);
...
IL_010c:
	{
		...
		MixedRealityPlayspace_set_Position_mC2919EB2593621FFF8BB47C3BEDEE23EEA2BEB04(L_40, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_mD9BC0AF99F27F474F2B8248FECA12381F2B57D74(L_41, /*hidden argument*/NULL);
		// if (CameraCache.Main.transform.position != Vector3.zero)
		Camera_tC44E094BAB53AFC8A014C6F9CFCE11F4FC38006C * L_42;
		L_42 = CameraCache_get_Main_m197C7A2C9D2EAE6AD083908F4CBC07262BDB75E7(/*hidden argument*/NULL);
		NullCheck(L_42);
